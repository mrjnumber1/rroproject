...
// eAthena additions
	...
	int raid_update_interval;
	int raid_short_damage_rate;
	int raid_long_damage_rate;
	int raid_weapon_damage_rate;
	int raid_magic_damage_rate;
	int raid_misc_damage_rate;
	int raid_flee_penalty;
