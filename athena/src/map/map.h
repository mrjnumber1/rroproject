...
//#define SERVER_LANG LANG_MSG_ENG
//#define SERVER_LANG_TXT "ENG"
...
#define MAX_VENDING 80
#define MAX_MAP_SIZE 512*512 // Wasn't there something like this already? Can't find it.. [Shinryo]
#define MOBID_EMPERIUM 1288
// Added definitions for WoESE objects. [L0ne_W0lf]
#define MOBID_BARRICADE1 1905
#define MOBID_BARRICADE2 1906
#define MOBID_GUARDIAN_STONE1 1907
#define MOBID_GUARDIAN_STONE2 1908
#define MOBID_BG_BARRICADE 1906
#define MOBID_BG_GUARDIAN_STONE1 2105
#define MOBID_BG_GUARDIAN_STONE2 2106
#define MOBID_BG_EMPERIUM 2107
...
#define map_flag_vs(m) (map[m].flag.pvp || map[m].flag.gvg_dungeon || map[m].flag.gvg || ((agit_flag) && map[m].flag.gvg_castle) || map[m].flag.battleground)
...
#define map_gvg_items(m) (map[m].flag.gvg || (agit_flag && map[m].flag.gvg_castle) || map[m].flag.allow_gvg_items)
// Allow BG item usage
#define map_bg_items(m) (map[m].flag.battleground || map[m].flag.allow_bg_items)
#define map_raid_items(m) (map[m].flag.allow_raid_items)
#define count_bg_stats(m) (map[m].flag.battleground && map[m].flag.bg_active)

#define map_nonlr_accessible(m) ( map[m].flag.nonlr_accessible || map[m].flag.town || map_gvg_items(m) || map_raid_items(m) || map_bg_items(m) )
#define map_nonlr_battle(m) ( map[m].flag.nonlr_accessible || map_gvg_items(m) || map_raid_items(m) || map_bg_items(m) )
...
enum npc_subtype { WARP, SHOP, SCRIPT, CASHSHOP, ITEMSHOP, VARSHOP };
...
struct map_data {
	...
	struct map_flag {
		...
		unsigned allow_gvg_items :1;
		unsigned allow_bg_items :1;
		unsigned allow_raid_items:1;
		unsigned blocked : 1;
		unsigned woe_set :1;
...
// char_id to name-conversion related functions
